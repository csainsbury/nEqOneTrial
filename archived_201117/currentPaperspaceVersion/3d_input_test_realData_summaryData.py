...
import numpy as np
# import numpy as np
dataset_1 = pd.read_csv('./hba1c_data_5y_2008-13_T2.csv')
...
dataset_2 = pd.read_csv('./sbp_data_5y_2008-13_T2.csv')
...
dataset_3 = pd.read_csv('./bmi_data_5y_2008-13_T2.csv')
...
dataset_y = pd.read_csv('./1y_mortality_5y_30bins_2008-13_T2.csv')
y = dataset_y.values
...
model.fit(X_train_values, y_train, batch_size = 128, epochs = 12)
score = model.evaluate(X_test_values, y_test, batch_size=128)
