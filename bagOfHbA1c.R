...
write.table(values_plusID_forExport, file = paste("~/R/_workingDirectory/nEqOneTrial/sourceData/interpolatedTS_hba1c_", unixRunInDurationYears,"y_", numberOfBins, "increments_", startRuninPeriod, "_to_", endRuninPeriod, "_locf.csv", sep=""), sep=",", row.names = FALSE)
...
#
write.table(y_vector_deadAt_1_year, paste("~/R/_workingDirectory/nEqOneTrial/sourceData/hba1c_1y_mortality", unixRunInDurationYears,"y_", numberOfBins, "increments_", startRuninPeriod, "_to_", endRuninPeriod, "_locf.csv", sep=""), sep = ",", row.names = FALSE)
...
write.table(y_vector_deadAt_3_year, paste("~/R/_workingDirectory/nEqOneTrial/sourceData/hba1c_3y_mortality", unixRunInDurationYears,"y_", numberOfBins, "increments_", startRuninPeriod, "_to_", endRuninPeriod, "_locf.csv", sep=""), sep = ",", row.names = FALSE)
#
write.table(y_vector_deadAt_4_year, paste("~/R/_workingDirectory/nEqOneTrial/sourceData/hba1c_4y_mortality", unixRunInDurationYears,"y_", numberOfBins, "increments_", startRuninPeriod, "_to_", endRuninPeriod, "_locf.csv", sep=""), sep = ",", row.names = FALSE)
